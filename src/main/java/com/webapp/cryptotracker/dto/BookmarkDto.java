...
public class BookmarkDto {
    ...
    public BookmarkDto(Integer id,
            ...
            String cabinClass,
            String route,
            String price, JourneyDetails departureDetails2, JourneyDetails returnDetails2
        ...
        this.route = route;
        this.price = price;
        this.departureDetails = new JourneyDetailsDto(departureDetails2);
        this.returnDetails = new JourneyDetailsDto(returnDetails2);
    }
